...
% ======================= LỌC DÃI CHẶN TƯƠNG TỰ CẦN THIẾT KẾ ======================
fc1_p = 3;
fc2_p = 11;
OMEGAc1_p = 2*pi*fc1_p;
OMEGAc2_p = 2*pi*fc2_p;
s = OMEGA_c * sp*(OMEGAc2_p - OMEGAc1_p) / (sp^2 + OMEGAc2_p*OMEGAc1_p) ;
Ha_s = subs(Ha_sTQ,s); % Hàm chuyển của lọc dãi chặn cần thiết kế

% =========================== LỌC DÃI CHẶN SỐ CẦN THIẾT KẾ =========================
% -------------- Hàm truyền đạt H(z)
sz = 2/ts * (1-u)/(1+u);
Hz = subs(Ha_s,sz);
